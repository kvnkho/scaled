...
class SchedulerProcess(multiprocessing.get_context("spawn").Process):
    def __init__(
        ...
        network_log_forwarding_address: ZMQConfig = None,
    ):
        ...
        self._network_log_forwarding_address = network_log_forwarding_address
    ...
    def run(self) -> None:
        ...
        self._task = self._loop.create_task(
            scheduler_main(
                ...
                network_log_forwarding_address=self._network_log_forwarding_address
            )
        )
